...
//   card.className = 'flip-clock__piece';
//   card.innerHTML = `<div class="flip-clock__card card"><div class="card__top"></div><div class="card__bottom"></div><div class="card__back"><div class="card__bottom"></div></div></div>
//     <span class="flip-clock__slot">${label}</span>`;
...
//   const cardBackBottom = card.querySelector('.card__back .card__bottom');
...
class Clock {
  ...
  start() {
    ...
    const updateClock = () => {
      ...
      // if timer has ended
      var t = this.updateFn(this.countdown);
